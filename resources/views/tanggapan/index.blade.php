    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
          ...
          <div class="container-fluid pt-4 px-4">
            <div class="col-12">
                <h6 class="mb-4">Data Tanggapan</h6>
                          ...
                          <tbody>
                            @foreach($tanggapan as $t)
                              <tr>
                                ...
                                <td>{{ $t->tanggapan }}</td>
                                <td>
                                    <a href="/tanggapan/edit/{{ $t->id_tanggapan }}" class="btn btn-sm btn-secondary m-2">Edit</a>
                                    <a href="/tanggapan/delete/{{ $t->id_tanggapan }}" class="btn btn-sm btn-danger m-2">Hapus</a>
                                </td>
                              </tr>
                              @endforeach
                          </tbody>
